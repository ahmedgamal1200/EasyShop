...
<div class="container-fluid">
    <div class="col-md-12">
        <div class="row">
            <h1 class="text-center text-primary">TV-Smart</h1>

            <?php
            include 'config.php';
            $record = mysqli_query($con, "SELECT * FROM `product_details`");
            while($row = mysqli_fetch_array($record)){
                if($row['pCategory'] === 'TV-smart'){
                    echo 
                    "
              ...
              <div class='card p-3 text-center border rounded border-2 border-danger m-auto mb-4 ' style='width: 23rem;'>
                 <img src='../admin/product/$row[pImage]' class='m-auto card-img-top border rounded border-1 border-muted' alt='...' style='height: 100%px; width: 100%px; '>
                 <div class='card-body'>
